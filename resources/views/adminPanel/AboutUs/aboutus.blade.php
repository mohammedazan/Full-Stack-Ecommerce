...
@section('main_content')
    ...
    <div class="page-content">
        ...
        <form method="post" action="{{route('company.aboutus.store')}}">
            @csrf
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="title" value="{{$aboutUs->title}}" class="form-control" id="exampleInputPassword1">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            <label for="exampleInputPassword1" class="form-label">history</label>
                                            <input type="text" name="history" value="{{$aboutUs->history}}" class="form-control" id="exampleInputPassword1">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            <label for="exampleInputPassword1" class="form-label">mission</label>
                                            <input type="text" name="mission" value="{{$aboutUs->mission}}" class="form-control" id="exampleInputPassword1">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            <label for="exampleInputPassword1" class="form-label"> vision</label>
                                            <input type="text" name="vision" value="{{$aboutUs->vision}}" class="form-control" id="exampleInputPassword1">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            <label for="exampleInputPassword1" class="form-label"> values</label>
                                            <input type="text" name="values" value="{{$aboutUs->values}}" class="form-control" id="exampleInputPassword1">
                                        </div>
                                    </div>
                                    {{-- <div class="col-sm-6">
                                        <div class="mb-3">
                            ...
                            {{-- <div class="col-sm-3">
                                <div class="mb-2 row">
                                    <div class="col-sm-12 mt-2">
                                        <input style="display:none" type="file" name="image_path" class="image">
                                        <div class="row d-flex " id="productImglist">
                                            <div class="imgmaindiv imgmaindiv" style="position:relative" id="222" onclick="selectImage('222')">
                                                ...
                                                <input type="hidden" name="image_path" value="{{$aboutUs->image_path}}" class="222input">
                                                
                                                <div class="imgaddcardinfopg d-flex justify-content-center align-items-center 222view ">
                                                    @if($aboutUs->image_path)
                                                        <img class="imgaddborder" src="{{asset($aboutUs->image_path)}}" alt="" width="100%" height="100%">
                                                    @else
...
@section('js')
    @section('js')
        ...
        <script>
            ...
            $("body").on("change", ".image_path", function (e) {
